...
dataset = codecs.open("presse/afd/afd_2016.tsv", "r", "utf-8").read().strip().split("\n")
...
output = codecs.open("presse/afd/afd_final_2016.tsv","w","utf-8")
...
dataset = codecs.open("presse/afd/afd_2017.tsv", "r", "utf-8").read().strip().split("\n")
...
output = codecs.open("presse/afd/afd_final_2017.tsv","w","utf-8")
